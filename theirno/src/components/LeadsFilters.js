        ...
        <div className="filters">
            <form className="filter-form d-flex justify-content-between">
                <div className="d-flex">
                    ...
                    />
                    <select className="form-control mr-3" id="serviceFilter">
                        <option selected disabled>Filter by service</option>
                        <option>Service Name 1</option>
                        <option>Service Name 2</option>
                        <option>Service Name 3</option>
                    </select>
                    <select className="form-control" id="paymentFilter">
                        <option selected disabled>Filter by payment status</option>
                        <option>Paid</option>
